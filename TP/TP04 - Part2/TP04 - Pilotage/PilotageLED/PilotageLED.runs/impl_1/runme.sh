...
HD_PWD='C:/Users/utilisateur/Documents/TP/TP04 - Part2/TP04 - Pilotage/PilotageLED/PilotageLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PilotageLED_Avec_Module_LedDriver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PilotageLED_Avec_Module_LedDriver.tcl -notrace
