...
HD_PWD='C:/Users/utilisateur/Documents/TP/TP04 - Part2/TP04 - Pilotage/PilotageLED/PilotageLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PilotageLED_Avec_Module_LedDriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PilotageLED_Avec_Module_LedDriver.tcl
