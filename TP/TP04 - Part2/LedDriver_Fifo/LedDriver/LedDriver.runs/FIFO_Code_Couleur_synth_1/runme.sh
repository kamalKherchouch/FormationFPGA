...
HD_PWD='C:/Users/utilisateur/Documents/TP/TP04 - Part2/LedDriver_Fifo/LedDriver/LedDriver.runs/FIFO_Code_Couleur_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_Code_Couleur.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_Code_Couleur.tcl
