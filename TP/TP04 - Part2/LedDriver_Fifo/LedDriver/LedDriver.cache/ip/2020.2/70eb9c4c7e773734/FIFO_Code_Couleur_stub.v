...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ FIFO_Code_Couleur_stub.v
...
/* synthesis syn_black_box black_box_pad_pin="clk,rst,din[1:0],wr_en,rd_en,dout[1:0],full,empty,wr_rst_busy,rd_rst_busy" */;
  input clk;
  input rst;
  input [1:0]din;
  input wr_en;
