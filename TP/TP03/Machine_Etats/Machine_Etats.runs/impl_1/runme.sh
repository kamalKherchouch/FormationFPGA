...
HD_PWD='C:/Users/utilisateur/Documents/TP/TP03/Machine_Etats/Machine_Etats.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tp_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tp_fsm.tcl -notrace
