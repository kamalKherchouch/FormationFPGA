...
HD_PWD='C:/Users/utilisateur/Documents/TP/TP05/Domaine_Horloge/Domaine_Horloge.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Domaine_Horloge.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Domaine_Horloge.tcl -notrace
