...
HD_PWD='C:/Users/utilisateur/Documents/TP/TP05/Domaine_Horloge/Domaine_Horloge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Domaine_Horloge.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Domaine_Horloge.tcl
