...
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { LED_Output }]; #IO_L16P_T2_35 Sch=led0_g
...
connect_debug_port u_ila_0/probe0 [get_nets [list {D_out[0]} {D_out[1]} {D_out[2]} {D_out[3]} {D_out[4]} {D_out[5]} {D_out[6]} {D_out[7]} {D_out[8]} {D_out[9]} {D_out[10]} {D_out[11]} {D_out[12]} {D_out[13]} {D_out[14]} {D_out[15]} {D_out[16]} {D_out[17]} {D_out[18]} {D_out[19]} {D_out[20]} {D_out[21]} {D_out[22]} {D_out[23]} {D_out[24]} {D_out[25]} {D_out[26]} {D_out[27]}]]
...
connect_debug_port u_ila_0/probe3 [get_nets [list LED_Output_OBUF]]
