...
HD_PWD='C:/Users/utilisateur/Documents/TP/Projet VGA/Code VHDL/Generateur_Pattern/Generateur_Pattern/Generateur_Pattern.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Generateur_Pattern.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Generateur_Pattern.tcl
