...
HD_PWD='C:/Users/utilisateur/Documents/TP/Projet VGA/Code VHDL/Generateur_Pattern/Generateur_Pattern/Generateur_Pattern.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Generateur_Pattern.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Generateur_Pattern.tcl -notrace
