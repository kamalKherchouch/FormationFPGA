...
#
# Generated by export_simulation on Fri Jul 07 11:18:05 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './Fifo_ligne_2.sh' script.

./Fifo_ligne_2.sh -reset_run
...
./Fifo_ligne_2.sh -noclean_files

For more information on the script, please type './Fifo_ligne_2.sh -help'.
