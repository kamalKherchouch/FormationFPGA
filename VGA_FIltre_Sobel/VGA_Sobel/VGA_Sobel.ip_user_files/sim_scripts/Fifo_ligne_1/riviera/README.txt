...
#
# Generated by export_simulation on Fri Jul 07 11:17:34 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './Fifo_ligne_1.sh' script.

./Fifo_ligne_1.sh -reset_run
...
./Fifo_ligne_1.sh -noclean_files

For more information on the script, please type './Fifo_ligne_1.sh -help'.
