...
HD_PWD='C:/Users/utilisateur/Documents/TP/VGA_FIltre_Sobel/VGA_Sobel/VGA_Sobel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_filtre_Sobel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_filtre_Sobel.tcl -notrace
