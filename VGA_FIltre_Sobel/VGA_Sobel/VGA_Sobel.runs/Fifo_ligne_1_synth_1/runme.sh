...
HD_PWD='C:/Users/utilisateur/Documents/TP/VGA_FIltre_Sobel/VGA_Sobel/VGA_Sobel.runs/Fifo_ligne_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fifo_ligne_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fifo_ligne_1.tcl
