...
HD_PWD='C:/Users/utilisateur/Documents/TP/VGA_FIltre_Sobel/VGA_Sobel/VGA_Sobel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_filtre_Sobel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_filtre_Sobel.tcl
