...
#
# Generated by export_simulation on Fri Jun 23 14:02:07 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './Fifo_Ligne2.sh' script.

./Fifo_Ligne2.sh -reset_run
...
./Fifo_Ligne2.sh -noclean_files

For more information on the script, please type './Fifo_Ligne2.sh -help'.
