...
#
# Generated by export_simulation on Fri Jun 23 14:01:46 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './Fifo_Ligne1.sh' script.

./Fifo_Ligne1.sh -reset_run
...
./Fifo_Ligne1.sh -noclean_files

For more information on the script, please type './Fifo_Ligne1.sh -help'.
