...
HD_PWD='C:/Users/utilisateur/Documents/TP/Projet_VGA/Generateur_Pattern/Generateur_Pattern.runs/Fifo_Ligne2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fifo_Ligne2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fifo_Ligne2.tcl
