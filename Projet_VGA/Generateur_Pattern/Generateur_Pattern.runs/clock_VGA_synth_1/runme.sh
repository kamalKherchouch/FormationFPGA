...
HD_PWD='C:/Users/utilisateur/Documents/TP/Projet VGA/Code VHDL/Generateur_Pattern/Generateur_Pattern/Generateur_Pattern.runs/clock_VGA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_VGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_VGA.tcl
